...
Текущая версия парсера не поддерживает команду delete, так что тест не может проверить работу эквивалентной PutIfAbsent команды более одного раза. После успешного прохождения теста Afina придётся остановить, второй раз тест она не пройдёт.
